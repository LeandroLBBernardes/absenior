...
export function ActivityPage() {
    ...
    const cardList = [
        {id: 1, title: 'Complete sílabas', subTitle: 'Selecione as sílabas para formar a palavra.', imagem: AtividadeSilabas, link: '/'},
        {id: 2, title: 'Forme palavras', subTitle: 'Selecione as letras para formar a palavra.', imagem: AtividadePalavras, link: '/'},
        {id: 3, title: 'Complete a frase', subTitle: 'Selecione a palavra que complete a frase', imagem: AtividadeFrases, link: '/'},
        {id: 4, title: 'Forme frases', subTitle: 'Selecione as palavras para formar a frase.', imagem: AtividadeFrasesPalavras, link: '/'},
        {id: 5, title: 'Ligue Imagem', subTitle: 'Selecione a imagem e a palavra correspondente.', imagem: AtividadeImagens, link: '/'},
        {id: 6, title: 'Jogo da associação', subTitle: 'Selecione as sílabas para formar a palavra.', imagem: AtividadeAssociacao, link: '/'}
    ];

    return(
        <div className='p-5 w-full h-full lg:h-screen activity-page'>
            <div className='flex flex-col bg-white rounded-3xl card-activity-page p-6 md:px-5 md:pt-2 md:pb-5 lg:px-0 lg:pt-0 lg:pb-5 h-full gap-20 md:gap-0 2xl:gap-10'>
                ...
                <div className='flex flex-col justify-center items-center gap-3 md:flex-row md:justify-between md:gap-0 md:text-md lg:text-lg pt-8 pb-6 lg:px-10'>
                    <div className='flex flex-col md:flex-row gap-3 md:gap-5 head-activity items-center'>
